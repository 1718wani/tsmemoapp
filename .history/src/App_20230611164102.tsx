    ...
    <div>
      <div>
        ...
        <div>
          ...
          >
            <div className="bg-white border rounded-xl shadow-sm sm:flex dark:bg-gray-800 dark:border-gray-700 dark:shadow-slate-700/[.7] w-5/6">
              ...
              <div className="flex flex-wrap">
                <div className="p-4 flex flex-col h-full sm:p-7">
                  ...
                  <p className="mt-1 text-gray-800 dark:text-gray-400 w-2/3">
