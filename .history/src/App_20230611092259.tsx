        ...
        <section className="text-gray-600 body-font">
          <div className="container px-5 py-24 mx-auto">
            <div className="flex flex-wrap -mx-4 -my-8">
              {notes.map((todo) => (
                <div className="py-8 px-4 w-full border rounded-xl m-5">
                  <div className="h-full flex items-start">
                    ...
                    <div className="flex-grow pl-6">
                      <p className="leading-relaxed mb-5">{todo.inputValue}</p>

                      <span className="flex flex-grow-2 flex-col">
                      <a>
            <span classa="bg-indigo-100 text-indigo-500 w-4 h-4 mr-2 rounded-full inline-flex items-center justify-center">
