...
function App() {
  ...
  return (
    <div>
      <div>
        <h2 className="font-bold text-center text-gray-600 text-3xl mt-8 mb-7" >メモ</h2>
        <div>
        ...
        <form onSubmit={(e) => handleSubmit(e)} className="flex flex-col items-center" >
          <textarea
            ...
            className="border border-gray-500 focus:border-blue-500 h-24 w-80 rounded-2xl p-3 mb-"
          />
