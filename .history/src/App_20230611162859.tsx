...
function App() {
  ...
  return (
    ...
    <img className="w-full h-full absolute top-0 left-0 object-cover" src="../src/docs/assets/img/500x600/img1.jpg" alt="Image Description">
  </div>
              <img
                className="w-14 h-auto rounded-b-xl flex-1"
