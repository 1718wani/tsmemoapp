        ...
        <section className="text-gray-600 body-font">
          <div className="container px-5 py-24 w-9/12 mx-auto">
            <div className="flex flex-wrap -mx-4 -my-8">
              {notes.map((todo) => 
              (
                <div className="py-6 px-4 w-full border rounded-xl m-5" key={todo.id}>
                  <div className="h-full flex items-start">
                    ...
                    <div className="flex-grow pl-6">
                      ...
                      <span className="flex">
                        ...
                        <span>
                            <span className=" text-red-300 bg-gray-50 w-4 h-4 mr-2 rounded-full inline-flex items-center justify-center ml-3">
                              <svg
                                fill="none"
                                stroke="currentColor"
                                stroke-linecap="round"
                            ...
                            <text className="font-color text-sla">重要</text>
                          </span>
