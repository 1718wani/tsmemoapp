    ...
    <>
      <div>
        <div>
          ...
          <NotePostForm handleSubmit={handleSubmit} imagePreview={imagePreview} inputValue={inputValue} handleChange={handleChange} handlePaste={handlePaste} isImportant={isImportant} handleTagBtn={handl} />
